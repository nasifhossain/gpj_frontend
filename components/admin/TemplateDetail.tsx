    ...
    return (
        <div className="mb-4">
            ...
            {field.fieldType === 'dropdown' ? (
                <>
                    <select
                        className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md border p-2 text-black bg-white disabled:bg-gray-50 disabled:text-gray-500"
                        disabled
                    >
                    ...
                    {field.options && field.options.length > 0 && (
                        <div className="mt-2 p-2 bg-blue-50 border border-blue-200 rounded-md">
                            <p className="text-xs font-semibold text-blue-900 mb-1">Available Options:</p>
                ...
                <textarea
                    className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md border p-2 text-black disabled:bg-gray-50 disabled:text-gray-500"
                    rows={3}
                    disabled
                ...
                <input
                    type="text"
                    className="shadow-sm focus:ring-indigo-500 text-black focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md border p-2 disabled:bg-gray-50 disabled:text-gray-500"
                    disabled
